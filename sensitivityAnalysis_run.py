...
mg1 = list(set(list(pd.read_csv('data/markerGenes/highlyVarGenes_WT_sgTAOK1_1584.csv', header = 0, index_col = 0).loc[:,'x'])).intersection(ccAF1_scanpy.var_names))
...
DF.to_csv('results/ACTINN/ccAF_CV_sensitivity_analysis.csv')
...
plt.savefig('results/CV_plots/ccAF_CV_sensitivity_analysis_boxplot.pdf')
plt.clf()
